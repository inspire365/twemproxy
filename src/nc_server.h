...
uint32_t server_pool_idx(struct server_pool *pool, uint8_t *key, uint32_t keylen, bool next);
struct conn *server_pool_conn(struct context *ctx, struct server_pool *pool, uint8_t *key, uint32_t keylen, bool next);
